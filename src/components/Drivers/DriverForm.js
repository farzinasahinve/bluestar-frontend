...
import { saveDriver } from "../../actions/driverAction";
                      ...
                      <div className="card">
                        <div className="card-body">
                            ...
                            <div className="row">
                              ...
                              <div className="col-md-6">
                                <div className="mb-4">
                                  <label htmlFor="validationCustom01" className="form-label">Driving License Issuing State </label>
                              ...
                              <div className="col-md-6">
                                <div className="mb-4">
                                  <label htmlFor="validationCustom02" className="form-label">Driver License Number </label>
                                  <input type="text" className="form-control"  placeholder=""  required=""/>
                      ...
                      <div className="card">
                        <div className="card-body">
                            ...
                            <div className="row">
                              <div className="col-md-12">
                                <div className="mb-4">
                                  <label htmlFor="validationCustom01" className="form-label">Assign Vechiles</label>
                                  <select className="form-control select2">
                      ...
                      <div className="card">
                        <div className="card-body">
                            ...
                            <div className="row">
                              <div className="col-md-12">
                                <div className="mb-4">
                                  <label htmlFor="validationCustom01" className="form-label">Cargo Type </label>
                            ...
                            <div className="form-check mb-3">
                              ...
                              <label className="form-check-label" htmlFor="invalidCheck">Allow Short-Haul Exceptaion  </label>
                            </div>
                      
                            <div className="form-check mb-3">
                                <input className="form-check-input" type="checkbox" value=""  required=""/>
                                <label className="form-check-label" htmlFor="invalidCheck">Allow Split-sleeper Birth  </label>
