...
const Drivers = () => {
    ...
    const totalRecords = drivers.TotalRecord
    useEffect(()=>{
        dispatch(getDriver())
    },[dispatch])
    const submitHandler = (e) => {
        ...
        dispatch(getDriver(searchKey,searchStatus));
    };
                                        ...
                                        <div className="col-auto col-3">
                                            <div className="d-inline-flex">
                                                <div className="col-sm-10">
                                                    <div className="form-group">
                                                        <label className="form-label">&nbsp;</label>
                                                        <Link to="/drivers/create" type="button" className="btn d-block add-button" ><i className="dripicons-plus font-size-20 vertical-align-top"></i> &nbsp; Add Driver</Link>
                                                    </div>
                                                </div>
