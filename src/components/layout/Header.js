...
const Header = ({pageHead}) => {
    const { error, user, logoutError } = useSelector((state) => state.auth);
                    ...
                    <div className="d-inline-block">
                        ...
                        <div className="dropdown d-inline-block user-dropdown">
                            <button type="button" className="btn header-item  font-size-13" id="page-header-user-dropdown"
                                ...
                                <span className="d-none d-xl-inline-block text-capitalize ms-1  font-size-14  user-name vertical-middle">{user?.firstName}<br></br><small>{user?.lastName}</small> </span>
