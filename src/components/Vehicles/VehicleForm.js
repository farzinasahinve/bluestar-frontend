...
import { saveVehicle } from "../../actions/vehicleAction"
...
const VehicleForm = () => {
    ...
    const submitHandler = (event)=>{
        ...
        console.log(values)
        dispatch(saveVehicle(values, navigate))
    }
    const pageHead = ''
    return (
        <>
                                        ...
                                        <div className="row mt-4">
                                            <div className="col-md-12">
                                                <div className="card">
                                                    <div className="card-body">
                                                        ...
                                                        <div className="row">
                                                            <div className="col-md-6">
                                                                <div className="mb-4">
                                                                    <label htmlFor="validationCustom01" className="form-label">Make </label>
                                                            ...
                                                            <div className="col-md-6">
                                                                <div className="mb-4">
                                                                    <label htmlFor="validationCustom02" className="form-label">Model </label>
                                                        ...
                                                        <div className="row">
                                                            <div className="col-md-6">
                                                                <div className="mb-4">
                                                                    <label htmlFor="validationCustom01" className="form-label">Plate License Issuing State </label>
                                                    ...
                                                    <div className="col-md-6">
                                                        <div className="mb-4">
                                                            <label htmlFor="validationCustom02" className="form-label">License Plate Number </label>
