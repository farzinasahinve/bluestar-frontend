...
import { manageVehicle,getVehicleDetail,getAllVehicles } from "./vehiclesSlice"
...
const VehicleEditForm = (props) => {
    ...
    const vehiclesObj = useSelector(getAllVehicles)
    const detail = vehiclesObj.detail
    const responseMessage = vehiclesObj?.responseMessage
    useEffect(()=>{
        //if(id){
    ...
    const [values, setValues] = useState({
        ...
        vin:detail.vin,
        year:detail.year,
        plateLicenseState:detail.plateLicenseState,
    ...
    useEffect(() => {
        if(vehiclesObj.is_updated === true) navigate('/settings/vehicles')
    },[vehiclesObj])
    const pageHead = ''
    return (
        <>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-sm-7">
                                                        <div className="form-group">
                                                            ...
                                                            <button type="submit" className="btn d-block w-100 add-button"><i className="dripicons-plus font-size-20 vertical-align-top"></i> Update Vehicle</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
